...
(function() {
  ...
  FreePages = (function() {
    ...
    FreePages.prototype.svg = null;

    FreePages.prototype.points = [];

    FreePages.prototype.handles = ["freepages"];

    FreePages.prototype.name = "freepages";

    FreePages.prototype.margin = {
      left: 40,
      right: 40,
      top: 40,
      bottom: 40
    ...
    FreePages.prototype.data = function(data, elem) {
      var line, x, y;
